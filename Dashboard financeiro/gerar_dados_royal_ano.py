"""Gera um ano inteiro de dados da ROYAL para o filtro de Ano do painel.

Companheiro de ``atualizar_dados.py`` e ``gerar_drilldown_dre.py``, mas com um
propósito bem específico: o painel exclusivo da ROYAL
(``painel_financeiro_royal.html``) tem um seletor de Ano (2025/2026, por
...
Uso (a partir da raiz do projeto)::
    ...
    .venv\\Scripts\\python.exe "Dashboard financeiro/gerar_dados_royal_ano.py" --ano 2025 > ano_2025.js
"""
...
try:
    ...
    raise SystemExit(
        ...
        '  .venv\\Scripts\\python.exe "Dashboard financeiro/gerar_dados_royal_ano.py"'
    ) from _exc
